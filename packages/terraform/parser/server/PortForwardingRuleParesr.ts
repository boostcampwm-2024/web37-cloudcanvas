...
export class PortForwardingRuleParser extends BaseResourceParser {
    ...
    protected createModel(properties: any): NCloudPortForwardingRule {
        return new NCloudPortForwardingRule({
            ...
            portForwardingExternalPort: properties.port_forwarding_external_port,
            portForwardingInternalPort: properties.port_forwarding_internal_port,
            portForwardingConfigurationNo: properties.port_forwarding_configuration_no,
