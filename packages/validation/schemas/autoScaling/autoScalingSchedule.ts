...
export const autoScalingScheduleSchema = z
    .object({
        ...commonSchema,
        name: z.string(),
    ...
    .refine(
        (data) => {
            return (
                data.desired_capacity >= data.min_size &&
    ...
    .refine(
        ...
        {
            message:
                'recurrence가 없을 경우 start_time과 end_time은 반드시 입력해야 합니다',
        },
    );

export type AutoScalingScheduleSchema = z.infer<
    typeof autoScalingScheduleSchema
>;
